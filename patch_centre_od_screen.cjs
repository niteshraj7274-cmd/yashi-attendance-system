...
export default function CentreOfficialDutyScreen() {
  ...
  const [dutyType, setDutyType] = useState('Field Work');
...
fs.writeFileSync('src/components/CentreOfficialDutyScreen.tsx', newComponentCode);
console.log("CentreOfficialDutyScreen Patched successfully");
